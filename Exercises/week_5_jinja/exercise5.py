...
# and the clock configuration. 
# The two NTP servers, the timezone, timezone_offset, and timezone_dst (daylight savings timezone name) 
# should be variables in these child templates.

# The output from this should be the full configuration which is basically identical to the 
# current running configuration on cisco3.lasthop.io.
